...
public class ObjectMovement : MonoBehaviour
{
    ...
    public int aksi ;
    public float speed;
    public int isi_peluru,hp = 20 ,jmlh_hp,jmlh_lvl,level=1;
    public static int score = 0 ,score2 = 0 ,hs = 0;
    ...
    void getScore(){
        if ( HitungKoin.koin > hs ){
            hs = HitungKoin.koin;
            SaveLoadHscore.SaveHighScore(hs);
        }
